...
ROOT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)/dockerContainer/node3"
...
OPENCLAW_CONFIG_DIR="${OPENCLAW_CONFIG_DIR:-$HOME/.openclawd}"
OPENCLAW_WORKSPACE_DIR="${OPENCLAW_WORKSPACE_DIR:-$HOME/.openclawd/workspace}"
...
export OPENCLAW_GATEWAY_PORT="${OPENCLAW_GATEWAY_PORT:-38789}"
export OPENCLAW_BRIDGE_PORT="${OPENCLAW_BRIDGE_PORT:-38790}"
